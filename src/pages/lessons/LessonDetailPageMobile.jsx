...
const LessonDetailPageMobile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.lesson_type === 'individual' && validStudents.length > 1) {
        setError('الدرس الفردي يمكن أن يحتوي على طالب واحد فقط')
        setLoading(false)
        return
      }
...
export default LessonDetailPageMobile
