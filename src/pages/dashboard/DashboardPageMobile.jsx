    ...
    <div className="dashboard-page dashboard-page-mobile">
      <div className="dashboard-header">
        <div>
          ...
          <p className="dashboard-subtitle">نظرة عامة على دروسك</p>
        </div>
              ...
              <div key={subject} className="subject-stat-card">
                ...
                <div className="subject-stats-grid">
                  <div className="subject-stat-item">
                    <span className="subject-stat-label">إجمالي:</span>
                    <span className="subject-stat-value">{stats.total_lessons || 0} درس ({stats.total_hours?.toFixed(2) || '0.00'} ساعة)</span>
                  </div>
                  <div className="subject-stat-item">
                    <span className="subject-stat-label">فردي:</span>
                    <span className="subject-stat-value">{stats.individual?.lessons || 0} درس</span>
                  </div>
                  <div className="subject-stat-item">
                    <span className="subject-stat-label">جماعي:</span>
                    <span className="subject-stat-value">{stats.group?.lessons || 0} درس</span>
                  </div>
                </div>
              </div>
            ))}
